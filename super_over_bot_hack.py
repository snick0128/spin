...
def sett(update: Update, context: CallbackContext) -> None:
        global list_to_use
        global wtf
        my_head = [687704187,2077961098,538542442,528815427,534884074,5265567223,1494153617,1749564319,861769159,5135111271,1777632324,1009100017,842447646,658064380,5029086550  ]
...
def main() -> None:
    ...
    updater = Updater("1917217223:AAH64_oD48Tawa6_POjD9hcSKOAkvtktgs0")
